...
{
    public class VectorProcessor50
    {
        public VectorProcessor50() { }
        ...
        public bool IsAccepted(string input, bool symbolMode, bool clockwise, bool sumCriterion)
        {
            ...
            foreach (char c in input)
            {
                if (symbolMode)
                {
                    switch (c)
                    {
                        ...
                        case 'c': currentSequence = "110"; break;
                        case 'd': currentSequence = "11101"; break;
                        case 'e': currentSequence = "001"; break;
                        case 'f': currentSequence = "100"; break;
            ...
            return sumCriterion ? sum % 5 == 0 : state == 0;
        }
    }
}
